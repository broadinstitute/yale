...
// AzureClientSecrets provides a mock function with given fields:
func (_m *YaleCRDInterface) AzureClientSecrets() v1beta1.AzureClientSecretInterface {
	ret := _m.Called()

	var r0 v1beta1.AzureClientSecretInterface
	if rf, ok := ret.Get(0).(func() v1beta1.AzureClientSecretInterface); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(v1beta1.AzureClientSecretInterface)
		}
	}
...
// YaleCRDInterface_AzureClientSecrets_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AzureClientSecrets'
type YaleCRDInterface_AzureClientSecrets_Call struct {
	*mock.Call
}

// AzureClientSecrets is a helper method to define mock.On call
func (_e *YaleCRDInterface_Expecter) AzureClientSecrets() *YaleCRDInterface_AzureClientSecrets_Call {
	return &YaleCRDInterface_AzureClientSecrets_Call{Call: _e.mock.On("AzureClientSecrets")}
}

func (_c *YaleCRDInterface_AzureClientSecrets_Call) Run(run func()) *YaleCRDInterface_AzureClientSecrets_Call {
...
func (_c *YaleCRDInterface_AzureClientSecrets_Call) Return(_a0 v1beta1.AzureClientSecretInterface) *YaleCRDInterface_AzureClientSecrets_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *YaleCRDInterface_AzureClientSecrets_Call) RunAndReturn(run func() v1beta1.AzureClientSecretInterface) *YaleCRDInterface_AzureClientSecrets_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *YaleCRDInterface_GcpSaKeys_Call) RunAndReturn(run func() v1beta1.GcpSaKeyInterface) *YaleCRDInterface_GcpSaKeys_Call {
	_c.Call.Return(run)
	return _c
}
