...
type Clients struct {
	iam        *iam.Service
	gcpMetrics *monitoring.MetricClient
	k8s        kubernetes.Interface
	crd        v1beta1client.YaleCRDInterface
	vault      *vaultapi.Client
}

func NewClients(gcpIAM *iam.Service, gcpPA *policyanalyzer.Service, gcpMetrics *monitoring.MetricClient, k8s kubernetes.Interface, crd v1beta1client.YaleCRDInterface, vault *vaultapi.Client) *Clients {
	return &Clients{
		iam:        gcpIAM,
...
func Build(local bool, kubeconfig string) (*Clients, error) {
	...
	gcpMetrics, err := buildMetricsClient()
	if err != nil {
	...
	return NewClients(gcpIam, gcpPA, gcpMetrics, k8s, crd, vault), nil
}
