...
func NewFakeVaultServer(t *testing.T, expectFn func(Expect)) *FakeVaultServer {
	_state := &state{
...
// AssertExpectations assert expectations
func (s *FakeVaultServer) AssertExpectations(t *testing.T) {
	s.expect.assert(t, s.state)
}
